            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <!-- form -->
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/user/recharge">
                            <#-- 用户信息 -->
                            ...
                            <#-- 余额 -->
                            <div class="form-group">
                                <label class="col-sm-3 control-label">当前书币余额：</label>
                                <div class="col-sm-7">
                                    <p class="form-control-static">${user.coin}</p>
                                </div>
                            </div>
