    ...
    <script>
        ...
        function edit(id){
            layer.open({
                ...
                shade: false,
                area: ['893px', '600px'],
                content: '/admin/country/form?id=' + id,
                end: function(index){
        ...
        function del(id) {
            layer.confirm('确定删除吗?', {icon: 1, title:'提示'}, function(index){
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "${ctx!}/admin/country/delete/" + id,
                ...
                layer.confirm('确定删除吗?', {icon: 1, title:'提示'}, function(index){
                    $(items).each(function (index, item) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "${ctx!}/admin/country/delete/" + item.id,
                            success: function(msg){
